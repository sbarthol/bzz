...
void PlayMode::draw(glm::uvec2 const &drawable_size) {
	...
	glUniform3fv(lit_color_texture_program->LIGHT_DIRECTION_vec3, 1, glm::value_ptr(glm::normalize(glm::vec3(0.0f, 0.0f, -1.0f))));
	glUniform3fv(lit_color_texture_program->LIGHT_ENERGY_vec3, 1, glm::value_ptr(glm::vec3(69.f, 25.f, 251.f) * 0.1f));
	glUniform3fv(lit_color_texture_program->LIGHT_LOCATION_vec3, 1, glm::value_ptr(glm::vec3(1.35f, 0.09f, 3.44f)));
	glUseProgram(0);
