...
LitColorTextureProgram::LitColorTextureProgram() {
	...
	,
		...
		"	vec3 e;\n"
		" vec3 room_light = (dot(n,-vec3(-1.0, 0.0, -1.0)) * 0.5 + 0.5) * 0.6 * vec3(1.0, 0.92, 0.63) + (dot(n,-vec3(1.0, 0.0, -1.0)) * 0.5 + 0.5) * 0.4 * vec3(1.0, 0.92, 0.63);\n"
